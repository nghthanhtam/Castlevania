...
void CGameObject::SetFreeze(bool flag)
{
	this->isFreezed = flag;
}

void CGameObject::SetStop(bool flag)
{
	isStop = flag;
}
...
//void CGameObject::GetSimonPos(float x, float y)
//{
//}
...
void CGameObject::SetIsOutOfCamera(bool flag)
{
	isOutOfCamera = flag;
}
